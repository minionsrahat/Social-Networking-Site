        ...
        <div class="col-md-7">
          ...
          <div class="friend-list">
            <div class="row">
              ...
              where users.user_id!='$user_id' and users.user_id=user_profile_status.user_id and users.user_id IN 
              (SELECT user_one_id FROM `relationships` WHERE (user_two_id='$user_id' and action_id != '$user_id' AND `status` = 0))";
              $users = $con->query($sql);
              // echo $sql ."<br>";
                  ...
                  <div class="friend-card">
                    ...
                    <div class="card-info">
                      ...
                      <div class="friend-info">
                        ...
                        <button onclick="accept_sent_request('<?php echo $row['user_id'] ?>')" id="<?php echo $row['user_id'] ?>" class=" btn btn-primary text-center">Accept Friend Request</button>
